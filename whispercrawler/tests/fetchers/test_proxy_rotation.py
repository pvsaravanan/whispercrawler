...
from whispercrawler.engines.toolbelt import ProxyRotator, cyclic_rotation, is_proxy_error
...
class TestCustomStrategies:
    ...
    def test_sticky_strategy(self):
        ...
        rotator = ProxyRotator(["http://p1:8080", "http://p2:8080"], strategy=sticky_strategy)
