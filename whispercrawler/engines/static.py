...
from ._browsers._types import DataRequestParams, GetRequestParams, ImpersonateType, RequestsSession
...
class _SyncSessionLogic(_ConfigurationLogic):
    ...
    def _make_request(
        ...
        selector_config = (
            self._get_param(kwargs, "selector_config", self.selector_config) or self.selector_config
        )
