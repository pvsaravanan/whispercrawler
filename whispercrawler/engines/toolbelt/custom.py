...
from whispercrawler.core.custom_types import MappingProxyType
from whispercrawler.core.utils import log
from whispercrawler.parser import Selector, SQLiteStorageSystem

if TYPE_CHECKING:
    from whispercrawler.spiders import Request
