...
from whispercrawler.core._types import Any, Dict, Iterable, List
...
def setup_logger():
    ...
    """
    logger = logging.getLogger("whispercrawler")
...
class _StorageTools:
    ...
    def element_to_dict(cls, element: html.HtmlElement) -> Dict:
        ...
        children = [
            child.tag for child in element.iterchildren() if not isinstance(child, html_forbidden)
        ]
        if children:
