...
from whispercrawler.core.custom_types import TextHandler
...
class CurlParser:
    ...
    def __init__(self) -> None:
        from whispercrawler.fetchers import Fetcher as __Fetcher
...
def show_page_in_browser(page: Selector):  # pragma: no cover
    ...
    try:
        fd, fname = make_temp_file(prefix="whispercrawler_view_", suffix=".html")
...
class CustomShell:
    ...
    def init_components(self):
        ...
        if self.log_level:
            getLogger("whispercrawler").setLevel(self.log_level)
