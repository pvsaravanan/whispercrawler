...
from whispercrawler.core.utils import reset_logger, set_logger
from whispercrawler.spiders.engine import CrawlerEngine
from whispercrawler.spiders.request import Request
from whispercrawler.spiders.result import CrawlResult, CrawlStats
...
class Spider(ABC):
    ...
    def __init__(
        self, crawldir: Optional[Union[str, Path, AsyncPath]] = None, interval: float = 300.0
    ):
        ...
        self.logger = logging.getLogger(f"whispercrawler.spiders.{self.name}")
        self.logger.setLevel(self.logging_level)
        self.logger.handlers.clear()
        self.logger.propagate = False  # Don't propagate to parent 'whispercrawler' logger
