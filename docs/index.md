...
```python
from whispercrawler.fetchers import Fetcher, StealthyFetcher, DynamicFetcher
...
<div style="text-align: center;">
  <a href="https://hypersolutions.co/?utm_source=github&utm_medium=readme&utm_campaign=whispercrawler" target="_blank" title="Bot Protection Bypass API for Akamai, DataDome, Incapsula & Kasada">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/HyperSolutions.png" class="ad">
  </a>
  <a href="https://birdproxies.com/t/whispercrawler" target="_blank" title="At Bird Proxies, we eliminate your pains such as banned IPs, geo restriction, and high costs so you can focus on your work.">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/BirdProxies.jpg" class="ad">
  </a>
  <a href="https://evomi.com?utm_source=github&utm_medium=banner&utm_campaign=WhisperCrawl-whispercrawler" target="_blank" title="Evomi is your Swiss Quality Proxy Provider, starting at $0.49/GB">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/evomi.png" class="ad">
  </a>
  <a href="https://tikhub.io/?utm_source=github.com/WhisperCrawl/WhisperCrawler&utm_medium=marketing_social&utm_campaign=retargeting&utm_content=carousel_ad" target="_blank" title="Unlock the Power of Social Media Data & AI">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/TikHub.jpg" class="ad">
  </a>
  <a href="https://www.nsocks.com/?keyword=2p67aivg" target="_blank" title="Scalable Web Data Access for AI Applications">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/nsocks.png" class="ad">
  </a>
  <a href="https://petrosky.io/WhisperCrawl" target="_blank" title="PetroSky delivers cutting-edge VPS hosting.">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/petrosky.png" class="ad">
  </a>
  <a href="https://substack.thewebscraping.club/p/whispercrawler-hands-on-guide?utm_source=github&utm_medium=repo&utm_campaign=whispercrawler" target="_blank" title="The #1 newsletter dedicated to Web Scraping">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/TWSC.png" class="ad">
  </a>
  <a href="https://proxy-seller.com/?partner=CU9CAA5TBYFFT2" target="_blank" title="Proxy-Seller provides reliable proxy infrastructure for Web Scraping">
    <img src="https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/ProxySeller.png" class="ad">
  </a>
  <br />
  <br />
</div>
...
<i><sub>Do you want to show your ad here? Click [here](https://github.com/sponsors/WhisperCrawl), choose a plan, and enjoy the rest of the perks!</sub></i>
...
<div id="chartContainer">
  <a href="https://github.com/WhisperCrawl/WhisperCrawler">
    <img id="chartImage" alt="Star History Chart" loading="lazy" src="https://api.star-history.com/svg?repos=WhisperCrawl/WhisperCrawler&type=Date" height="400"/>
  </a>
</div>
...
const observer = new MutationObserver((mutations) => {
  mutations.forEach((mutation) => {
    if (mutation.attributeName === 'data-md-color-media') {
      ...
      const baseUrl = 'https://api.star-history.com/svg?repos=WhisperCrawl/WhisperCrawler&type=Date';
...
1. If you are going to use any of the extra features below, the fetchers, or their classes, you will need to install fetchers' dependencies and their browser dependencies as follows:
    ...
    whispercrawler install           # normal install
    whispercrawler install  --force  # force reinstall
    ```
...
- 🐛 Report bugs and suggest features through [GitHub Issues](https://github.com/WhisperCrawl/WhisperCrawler/issues)
