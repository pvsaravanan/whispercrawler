...
page = Fetcher.get('https://whispercrawler.requestcatcher.com/get', impersonate="chrome")
```
...
>>> page = Fetcher.post('https://whispercrawler.requestcatcher.com/post', data={'key': 'value'}, proxy='http://username:password@localhost:8030')
>>> page = Fetcher.put('https://whispercrawler.requestcatcher.com/put', data={'key': 'value'})
>>> page = Fetcher.delete('https://whispercrawler.requestcatcher.com/delete')
```
...
>>> page = await AsyncFetcher.post('https://whispercrawler.requestcatcher.com/post', data={'key': 'value'}, proxy='http://username:password@localhost:8030')
>>> page = await AsyncFetcher.put('https://whispercrawler.requestcatcher.com/put', data={'key': 'value'})
>>> page = await AsyncFetcher.delete('https://whispercrawler.requestcatcher.com/delete')
```
...
>>> page = DynamicFetcher.fetch('https://www.google.com/search?q=%22WhisperCrawler%22', disable_resources=True)  # Vanilla Playwright option
>>> page.css("#search a::attr(href)").get()
'https://github.com/WhisperCrawl/WhisperCrawler'
>>> # The async version of fetch
>>> page = await DynamicFetcher.async_fetch('https://www.google.com/search?q=%22WhisperCrawler%22', disable_resources=True)
>>> page.css("#search a::attr(href)").get()
'https://github.com/WhisperCrawl/WhisperCrawler'
```
