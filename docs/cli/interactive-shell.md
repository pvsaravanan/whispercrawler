...
whispercrawler shell -c "get('https://quotes.toscrape.com'); print(len(page.css('.quote')))"
...
<img src="../assets/whispercrawler_shell_curl.png" title="Copying a request as a curl command from Chrome" alt="Copying a request as a curl command from Chrome" style="width: 70%;"/>

- **Convert Curl command to Request Object**

    ```python
    >>> curl_cmd = '''curl 'https://whispercrawler.requestcatcher.com/post' \
    ...   -X POST \
    ...
    'post'
    >>> request.url
    'https://whispercrawler.requestcatcher.com/post'
    >>> request.headers
