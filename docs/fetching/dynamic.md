...
WhisperCrawler provides many options with this fetcher and its session classes. To make it as simple as possible, we will list the options here and give examples of how to use most of them.
...
```python
from whispercrawler.fetchers import DynamicSession, ProxyRotator
...
```python
page = DynamicFetcher.fetch('https://raw.githubusercontent.com/WhisperCrawl/WhisperCrawler/main/images/main_cover.png')
...
```python
from whispercrawler.fetchers import DynamicSession
