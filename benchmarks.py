...
from whispercrawler import Selector as WhisperCrawlerSelector
...
def test_whispercrawler():
    ...
    return WhisperCrawlerSelector(large_html, adaptive=False).css(".item::text").getall()
...
@benchmark
def test_whispercrawler_text(request_html):
    return (
        WhisperCrawlerSelector(request_html, adaptive=False)
